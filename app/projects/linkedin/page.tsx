          ...
          <StaggerWrapper {...getTransition(3)}>
            <section className="flex flex-col gap-5">
              <div className="flex flex-col gap-1">
                ...
                <p className="b_serif">
                  25% of users found the generated content off-brand, while 18%
                  described it as generic or robotic, leading marketers to
            ...
            <section className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="b_serif">
                    Currently, we use Shutterstock to source images and generate
                    product descriptions from a company’s website to craft ad
                    copy.
                  </p>
                </div>
                <div className="w-full inner-shadow-tertiary rounded-[0.375rem]">
            ...
            <section className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-1">
                  ...
                  <div className="rounded-[0.375rem] bg-fill px-2 py-[0.875rem] inner-shadow-tertiary">
                    <p className="b_serif">
                      <span className="font-medium">Foundational:</span> A core
                      input for AI ad generation, influencing all elements.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="flex flex-col gap-5">
              <div className="flex flex-col gap-1">
                ...
                <p className="b_serif">
                  ...
                  offered quick, high-value impact. I worked with engineers and
                  PMs to plan internal and MVP releases, deliberately excluding
                  complex branding elements less relevant to this audience.
                </p>
              </div>
            </section>
          </StaggerWrapper>
            ...
            <section className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="b_serif">
                    We wanted the Brand Kit to be accessible without diminishing
                    the sense of magic in the campaign creation flow. This meant
                    ensuring users could incorporate their brand assets
                    effortlessly, without interrupting their creative process.
                  </p>
                </div>
                <div className="w-full inner-shadow-tertiary rounded-[0.375rem]">
                  <Image
              ...
              <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="b_serif">
                    ...
                    Accelerate-related inputs. Brand kit and product description
                    are connected which created lots of discussion.
                  </p>
                </div>
                <div className="w-full inner-shadow-tertiary rounded-[0.375rem]">
                  <Image
            ...
            <section className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-[3rem]">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <h4 className="text-primary-color-light">
                    Coach AI helps ensure your desired tone stays consistent as
                    you write.
                  </h4>
                </div>
                <div className="flex flex-col gap-1">
